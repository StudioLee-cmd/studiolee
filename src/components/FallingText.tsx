...
const FallingText = () => {
    ...
    useEffect(() => {
        ...
        const allWords = [
            // SERIOUS BENEFITS
            "Minder meetings, meer impact 🚀",
            "Laat AI het zware werk doen 🏋️‍♂️",
            "Sales op de automatische piloot ✈️",
            "Geen gemiste leads meer 🎯",
            "Klantenservice die nooit slaapt 🌙",
            "Schaalbaar zonder extra personeel 📈",
            "Meer omzet, minder stress 💸",
            "Van chaos naar structuur 🏗️",
            "Data liegt niet 📊",
            "Altijd vriendelijk (zelfs op maandag) 😊",
            "Foutloze administratie ✅",
            "Terugtijd voor ondernemen 🕒",
            "Klanttevredenheid door het dak 🏠",
            "Direct antwoord, altijd ⚡",
            "Professionaliteit x 1000 👔",
            ...
            // FUNNY / RELATABLE
            "Eindelijk die inbox leeg 📧",
            "Je stagiair is jaloers 🤖",
            "Je concurrentie te slim af 🧠",
            "Geen koffiepauzes nodig ☕",
            "Werkt 24/7, vraagt nooit opslag 💰",
            "Jouw digitale superkracht 💪",
            "Eindelijk weekend houden 🍻",
            "Geen 'Zal ik even terugbellen?' meer 📞",
            "Slimmer werken, niet harder 🧠",
            "Je nieuwe beste werknemer 🤝",
            "Geen ziektedagen meer 🤒",
            "Spreadsheets zijn zó 2023 📉",
            "Kantoorheld status: Unlocked 🦸‍♂️"
        ];
