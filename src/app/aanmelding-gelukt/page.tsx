            ...
            <Container className="flex-grow flex items-center justify-center py-24">
                <div className="max-w-2xl mx-auto text-center">
                    ...
                    <p className="text-xl text-gray-600 mb-12">
                        Gefeliciteerd! We zijn direct begonnen met het klaarmaken van jouw STUDIOLEE account.
                    </p>
                        ...
                        <div className="space-y-6">
                            <div className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">Je ontvangt een e-mail van <strong>AI Reclame Studio</strong> met jouw inloggegevens. Check ook je <u>spamfolder</u>.</p>
                                </div>
                            </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <Link
                            href="https://app.studiolee.nl" // Assumption: this URL exists, or use generic login placeholder
