        ...
        <Container>
            <div className="py-20 max-w-4xl mx-auto">
                ...
                <div className="prose prose-lg text-foreground-accent">
                    ...
                    <p>
                        Deze algemene voorwaarden zijn van toepassing op alle diensten van STUDIOLEE. Door gebruik te maken van onze diensten, ga je akkoord met deze voorwaarden.
                    </p>

                    <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">2. Dienstverlening</h2>
                    <p>
                        STUDIOLEE is een handelsnaam van <strong>DigitalStudioLee</strong> (KVK: 98933353). Wij leveren software-oplossingen (SaaS) voor ondernemers, waaronder AI-telefonie, chatbots en social media automatisering.
                    </p>
                    ...
                    <p>
                        STUDIOLEE is niet aansprakelijk voor indirecte schade, gevolgschade of winstderving. Onze maximale aansprakelijkheid is te allen tijde beperkt tot het bedrag van de, voor de desbetreffende dienst, in de maand van de gebeurtenis betaalde abonnementsgelden.
                    </p>
                    <p className="mt-4">
                    ...
                    <p>
                        ...
                        <strong>Email:</strong> tim@studiolee.nl
                    </p>
                </div>
            </div>
        </Container>
